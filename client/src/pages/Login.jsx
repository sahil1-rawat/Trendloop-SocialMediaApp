...
const Login = () => {
  ...
  const { isLoading, isAuth, setIsAuth, usersData, setUsersData } =
    useUserStore();
      ...
      <div className='bg-white shadow-xl rounded-2xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row'>
        ...
        <div className='w-full md:w-1/2 bg-white p-8 md:p-10'>
          ...
          <p className='text-gray-600 mt-4 mb-3 flex justify-center'>
            <img
              src='https://readme-typing-svg.herokuapp.com/?lines=Your+Trendloop+account+is+waiting!;Log+in+to+stay+connected.&color=800080'
              className='mx-auto'
            />
          </p>
